...
class TMCEvent:
    ...
    RC_DEFEATED_GIBDOS = "RC: Defeated Gibdos"
    RC_SECOND_KEY_BLOCK_OPEN = "RC: Second Key Block Open"
    RC_FIRST_KEY_BLOCK_OPEN = "RC: First Key Block Open"
    RC_MUSHROOM_DOOR_OPEN = "RC: Mushroom Door Open"
    ...
    DWS_MAP_CHEST_OPEN = "DWS: Map Chest Open"
    DWS_BARREL_EAST_DOOR_OPEN = "DWS: Barrel East Door Open"
    DWS_BARREL_NORTH_WEST_CHEST_OPEN = "DWS: Barrel North West Chest Open"
    DWS_EZLO_TALKS_ABOUT_BARREL = "DWS: Ezlo Talks About Barrel"
    DWS_BRIDGE_BUTTON_HIT = "DWS: Bridge Button Hit"
    DWS_MULLDOZERS_DEFEATED = "DWS: Mulldozers Defeated"
    ...
    DWS_LILY_PAD_IN_ROOM_16 = "DWS: Lily Pad In Room 16"
    DWS_ROOM_16_SMALL_KEY_CHEST_OPEN = "DWS: Room 16 Small Key Chest Open"
    DWS_COMPASS_CHEST_OPEN = "DWS: Compass Chest Open"
    DWS_POT_SET_ON_CHEST_BUTTON = "DWS: Pot Set On Chest Button"
    DWS_POT_SET_ON_ROOM_15_BUTTON = "DWS: Pot Set On Room 15 Button"
    DWS_ROOM_14_DOOR_OPEN = "DWS: Room 14 Door Open"
    DWS_EZLO_TALKS_ABOUT_LILYPAD = "DWS: Ezlo Talks About Lilypad"
    DWS_OBTAINED_HEART_CONTAINER = "DWS: Obtained Heart Container"

    DWS_SEEN_GREEN_CHUCHU_CUTSCENE = "DWS: Seen Green Chuchu Cutscene"
    DWS_BOSS_DOOR_OPEN = "DWS: Boss Door Open"
    DWS_RED_RUPEE_CHEST_OPEN = "DWS: Red Rupee Chest Open"
    DWS_REVEALED_CHEST_BUTTON = "DWS: Revealed Chest Button"
    DWS_HIT_CHEST_BUTTON = "DWS: Hit Chest Button"
    DWS_SMALL_KEY_CHEST_SPAWNED = "DWS: Small Key Chest Spawned"
    DWS_EZLO_TALKS_ABOUT_MOVING_BARREL = "DWS: Ezlo Talks About Moving Barrel"
    DWS_OBTAINED_HEART_PIECE = "DWS: Obtained Heart Piece"
    ...
    COF_ROOM_11_SMALL_KEY_CHEST_OPEN = "CoF: Room 11 Small Key Chest Open"
    COF_CANE_OF_PACCI_CHEST_OPEN = "CoF: Cane Of Pacci Chest Open"
    COF_BLEW_UP_WALL_TO_HEART_PIECE = "CoF: Blew Up Wall To Heart Piece"
    COF_EZLO_TALKS_ABOUT_CAVE_OF_FLAMES = "CoF: Ezlo Talks About Cave Of Flames"
    COF_MINECART_SWITCH_FLIPPED = "CoF: Minecart Switch Flipped"
    COF_OPENED_DOORS_TO_SWITCH = "CoF: Opened Doors To Switch"
    COF_EZLO_TALKS_ABOUT_MINECART = "CoF: Ezlo Talks About Minecart"
    COF_BLEW_UP_WALL = "CoF: Blew Up Wall"
    ...
    FOW_VISIT_05 = "FoW: Visit 05"
    FOW_VISIT_06 = "FoW: Visit 06"
    FOW_VISIT_07 = "FoW: Visit 07"
    FOW_VISIT_08 = "FoW: Visit 08"
    FOW_VISIT_09 = "FoW: Visit 09"
    FOW_VISIT_10 = "FoW: Visit 10"
    FOW_VISIT_11 = "FoW: Visit 11"
    FOW_VISIT_12 = "FoW: Visit 12"
    FOW_VISIT_13 = "FoW: Visit 13"
    FOW_VISIT_14 = "FoW: Visit 14"
    FOW_VISIT_15 = "FoW: Visit 15"
    FOW_VISIT_16 = "FoW: Visit 16"
    FOW_VISIT_17 = "FoW: Visit 17"
    FOW_VISIT_18 = "FoW: Visit 18"
    FOW_VISIT_19 = "FoW: Visit 19"
    FOW_VISIT_20 = "FoW: Visit 20"
    FOW_VISIT_21 = "FoW: Visit 21"
    FOW_VISIT_22 = "FoW: Visit 22"
    FOW_VISIT_23 = "FoW: Visit 23"
    FOW_DEFEATED_EYEGORES = "FoW: Defeated Eyegores"
    FOW_COMPASS_CHEST_OPEN = "FoW: Compass Chest Open"
    FOW_RIGHT_SIDE_KEY_BOSS_KEY_SIDE_DOOR_OPEN = "FoW: Right Side Key Boss Key Side Door Open"
    FOW_RIGHT_SIDE_3F_DOOR_OPEN = "FoW: Right Side 3 F Door Open"
    FOW_RIGHT_KEY_DROP_ANIMATION_FINISHED = "FoW: Right Key Drop Animation Finished"

    FOW_CENTER_DOOR_2F_SHOT_ARROWS_AT_EYES = "FoW: Center Door 2F Shot Arrows At Eyes"
    FOW_CENTER_DOOR_2F_EZLO_TALKS_ABOUT_BRIDGE = "FoW: Center Door 2F Ezlo Talks About Bridge"
    FOW_CENTER_DOOR_2F_DEFEATED_WALLMASTERS = "FoW: Center Door 2F Defeated Wallmasters"
    FOW_CENTER_DOOR_2F_BUTTONS_HIT = "FoW: Center Door 2F Buttons Hit"
    FOW_CENTER_DOOR_2F_DOOR_OPEN = "FoW: Center Door 2F Door Open"
    FOW_CENTER_DOOR_2F_KEY_FALLEN = "FoW: Center Door 2F Key Fallen"
    FOW_CENTER_DOOR_2F_OBTAINED_KEY = "FoW: Center Door 2F Obtained Key"
    FOW_CENTER_DOOR_2F_HIT_BUTTON = "FoW: Center Door 2F Hit Button"

    FOW_LEFT_SIDE_2F_DEFEATED_STALFOS = "FoW: Left Side 2F Defeated Stalfos"
    FOW_DEFEATED_MAZAAL = "FoW: Defeated Mazaal"
    FOW_OBTAINED_HEART_CONTAINER = "FoW: Obtained Heart Container"
    FOW_LEFT_SIDE_2F_SHOT_ARROW_AT_EYE = "FoW: Left Side 2F Shot Arrow At Eye"
    FOW_LEFT_SIDE_2F_BLEW_UP_WALL = "FoW: Left Side 2F Blew Up Wall"
    FOW_CENTER_ROOM_2F_LEFT_EYEGORE_DEFEATED = "FoW: Center Room 2F Left Eyegore Defeated"
    FOW_CENTER_DOOR_2F_LEFT_DOOR_OPEN = "FoW: Center Door 2F Left Door Open"
    FOW_CENTER_DOOR_2F_RIGHT_DOOR_OPEN = "FoW: Center Door 2F Right Door Open"
    ...
    TOD_OPENED_DOOR_TO_LILYPAD = "ToD: Opened Door To Lilypad"
    TOD_ICE_BLOCK_MELTED = "ToD: Ice Block Melted"
    TOD_EAST_LEVER_PUSHED = "ToD: East Lever Pushed"
    TOD_EAST_ICE_BLOCK_THAWING_ZONE_ACTIVE = "ToD: East Ice Block Thawing Zone Active"
    TOD_WEST_LEVER_PUSHED = "ToD: West Lever Pushed"
    TOD_WATER_ELEMENT_ICE_MELTS = "ToD: Water Element Ice Melts"
    TOD_OBTAINED_HEART_CONTAINER = "ToD: Obtained Heart Container"
    TOD_BLUE_CHU_DOOR_OPEN = "ToD: Blue Chu Door Open"
    TOD_MELTED_TOP_LEFT_ICE_BLOCK = "ToD: Melted Top Left Ice Block"
    TOD_MELTED_BOTTOM_LEFT_ICE_BLOCK = "ToD: Melted Bottom Left Ice Block"
    TOD_MELTED_TOP_RIGHT_ICE_BLOCK = "ToD: Melted Top Right Ice Block"
    TOD_MELTED_BOTTOM_RIGHT_ICE_BLOCK = "ToD: Melted Bottom Right Ice Block"
    TOD_LEVER_PUSHED = "ToD: Lever Pushed"
    TOD_LANTERN_CHEST_OPEN = "ToD: Lantern Chest Open"
    TOD_BLEW_UP_WALL_TO_MULLDOZER_KEY_ROOM = "ToD: Blew Up Wall To Mulldozer Key Room"
    TOD_LIT_TOP_LEFT_TORCH = "ToD: Lit Top Left Torch"
    TOD_LIT_TOP_RIGHT_TORCH = "ToD: Lit Top Right Torch"
    TOD_DARK_MAZE_DOOR_OPEN = "ToD: Dark Maze Door Open"
    TOD_LIT_MIDDLE_RIGHT_TORCH = "ToD: Lit Middle Right Torch"
    TOD_LIT_BOTTOM_RIGHT_TORCH = "ToD: Lit Bottom Right Torch"
    TOD_DEFEATED_TWIN_MADDERPILLARS = "ToD: Defeated Twin Madderpillars"
    TOD_BURNT_ENTRANCE_WEB = "ToD: Burnt Entrance Web"
    ...
    POW_BOSS_KEY_CHEST_OPEN = "PoW: Boss Key Chest Open"
    POW_SMALL_KEY_CHEST_OPEN_WEST_BOSS = "PoW: Small Key Chest Open West Boss"
    POW_BOSS_DOOR_OPEN = "PoW: Boss Door Open"
    POW_RED_W_KINSTONE_CHEST_OPEN = "PoW: Red W Kinstone Chest Open"
    POW_HIT_FAN_FLOOR_BUTTON_5F_MOBLIN_WIZZROBE = "PoW: Hit Fan Floor Button 5 F Moblin Wizzrobe"
    POW_DEFEATED_MOBLINS_WIZZROBES = "PoW: Defeated Moblins Wizzrobes"
    POW_5F_STALFOS_CLONE_DOOR_OPEN = "PoW: 5 F Stalfos Clone Door Open"
    POW_5F_KEY_CHEST_BLOCKS_DOOR_OPEN = "PoW: 5 F Key Chest Blocks Door Open"
    POW_HIT_FAN_FLOOR_BUTTON_5F_KEY_CHEST = "PoW: Hit Fan Floor Button 5 F Key Chest"
    POW_SMALL_KEY_CHEST_OPEN_5F_KEY_CHEST = "PoW: Small Key Chest Open 5 F Key Chest"
    POW_5F_BOSS_DOOR_HALL_DOOR_OPEN = "PoW: 5 F Boss Door Hall Door Open"
    POW_DEFEATED_BALL_CHAIN_SOLDIERS = "PoW: Defeated Ball Chain Soldiers"
    POW_OBTAINED_KEY = "PoW: Obtained Key"
    POW_BOSS_HALL_DOOR_OPEN = "PoW: Boss Hall Door Open"
    POW_TOP_BLOCK_DESTROYED_5F_NORTH_CORNER = "PoW: Top Block Destroyed 5 F North Corner"
    POW_BOTTOM_BLOCK_DESTROYED_5F_NORTH_CORNER = "PoW: Bottom Block Destroyed 5 F North Corner"
    POW_BLEW_UP_WALL_5F_GIBDO_CORNER = "PoW: Blew Up Wall 5 F Gibdo Corner"
    POW_BLEW_UP_WALL_5F_OUTSIDE_WALL = "PoW: Blew Up Wall 5 F Outside Wall"
    POW_BLUE_L_KINSTONE_CHEST_OPEN = "PoW: Blue L Kinstone Chest Open"
    POW_TOP_BLOCK_DESTROYED_4F_BOMBAROSSA = "PoW: Top Block Destroyed 4 F Bombarossa"
    POW_BOTTOM_BLOCK_DESTROYED = "PoW: Bottom Block Destroyed"
    POW_HIT_3_SWITCHES = "PoW: Hit 3 Switches"
    POW_3F_SPIKE_BAR_DOOR_OPEN = "PoW: 3 F Spike Bar Door Open"
    POW_2F_FLOORMASTER_DOOR_OPEN = "PoW: 2 F Floormaster Door Open"
    POW_DEFEATED_FIRE_WIZZROBES = "PoW: Defeated Fire Wizzrobes"
    POW_MAP_CHEST_OPEN = "PoW: Map Chest Open"
    POW_EZLO_TALKS_ABOUT_FANS = "PoW: Ezlo Talks About Fans"
    POW_HIT_PEAHAT_SWITCHES = "PoW: Hit Peahat Switches"
    POW_PEAHAT_LOCKED_DOOR_OPEN = "PoW: Peahat Locked Door Open"
    POW_2F_SHORTCUT_HIT_SWITCHES = "PoW: 2 F Shortcut Hit Switches"
    POW_KINSTONE_DEFEATED_WIZZROBES = "PoW: Kinstone Defeated Wizzrobes"
    POW_RED_KINSTONE_CHEST_OPEN = "PoW: Red Kinstone Chest Open"
    POW_SMALL_KEY_SPIKEBAR_CHEST_OPEN = "PoW: Small Key Spikebar Chest Open"
