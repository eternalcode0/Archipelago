...
class TMCItem:
    ...
    KINSTONE = "Broken Kinstone (Report Me!)"  # FIXME: Remove, update locations with correct kinstone type
    ...
    KINSTONE_RED_V = "Kinstone Red V"
    KINSTONE_RED_E = "Kinstone Red E"
    KINSTONE_BLUE_L = "Kinstone Blue L"
    KINSTONE_BLUE_6 = "Kinstone Blue S"
    KINSTONE_GREEN_C = "Kinstone Green C"
    KINSTONE_GREEN_G = "Kinstone Green G"
